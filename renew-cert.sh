...
openssl x509 -req -in $CERT_DIR/$DOMAIN/$DOMAIN.csr -CA $SCRIPT_DIR/root_ca.crt -CAkey $SCRIPT_DIR/root_ca.key -CAcreateserial -out $CERT_DIR/$DOMAIN/$DOMAIN.crt.new -days 365 -sha256
